...
$LAN_CONFIGURATION_051 = "The message that banned users will see when they attempt to connect to your servers. Use the Var \'gb_time\' to add the lenght of the ban in the message, example: You are banned gb_time. Visit www.yourweb.com/banned/ for more info.";
